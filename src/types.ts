...
export type SortField = 'name' | 'number' | 'set' | 'rarity' | 'color' | 'type' | 'price' | 'quantity' | null;
...
// ===============================
// Card and Collection Types
// ===============================

// Type for a card with quantity in collection
...
export type Pricing = {
  retail?: PricingCategory;
  buylist?: PricingCategory;
};
...
export type CardSet = {
  ...
  variations?: string[];
  watermark?: string;
  quantity?: number; // Optional quantity field for UI components
};
